 ...
 */
final class Version20210712090106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contrat CHANGE domaine_id domaine_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE interimaire CHANGE categorie_id categorie_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contrat CHANGE domaine_id domaine_id INT NOT NULL');
        $this->addSql('ALTER TABLE interimaire CHANGE categorie_id categorie_id INT NOT NULL');
    }
}
