 ...
 */
final class Version20210713105930 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE attestation ADD date_debut DATETIME DEFAULT NULL, ADD date_fin DATETIME DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE document (id INT AUTO_INCREMENT NOT NULL, agence_id INT DEFAULT NULL, type_document_id INT DEFAULT NULL, contrat_id INT DEFAULT NULL, user_id INT DEFAULT NULL, interimaire_id INT DEFAULT NULL, libelle VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, date_creation DATETIME NOT NULL, etat TINYINT(1) DEFAULT NULL, INDEX IDX_D8698A761823061F (contrat_id), INDEX IDX_D8698A76A76ED395 (user_id), INDEX IDX_D8698A76D725330D (agence_id), INDEX IDX_D8698A765CA839FE (interimaire_id), INDEX IDX_D8698A768826AFA6 (type_document_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE document_interimaire (id INT AUTO_INCREMENT NOT NULL, interimaire_id INT DEFAULT NULL, document_id INT DEFAULT NULL, contrat_id INT DEFAULT NULL, INDEX IDX_E93EE4F81823061F (contrat_id), UNIQUE INDEX UNIQ_E93EE4F8C33F7837 (document_id), INDEX IDX_E93EE4F85CA839FE (interimaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE attestation DROP date_debut, DROP date_fin');
    }
}
