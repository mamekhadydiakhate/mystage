...
return [
    ...
    'autorites' => [[], ['_controller' => 'App\\Controller\\AutoriteController::addAutorite'], [], [['text', '/autorite']], [], []],
    'autorite' => [[], ['_controller' => 'App\\Controller\\AutoriteController::listAutorite'], [], [['text', '/autorite']], [], []],
    'app_autorite_detailsautorite' => [['id'], ['_controller' => 'App\\Controller\\AutoriteController::detailsAutorite'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/autorite']], [], []],
    'app_autorite_rechercherautorite' => [[], ['_controller' => 'App\\Controller\\AutoriteController::rechercherAutorite'], [], [['text', '/rechercheautorite']], [], []],
    'delete_autorite' => [['id'], ['_controller' => 'App\\Controller\\AutoriteController::deleteAutorite'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/autorite']], [], []],
    'app_autorite_modifiautorite' => [['id'], ['_controller' => 'App\\Controller\\AutoriteController::modifiAutorite'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/autorite']], [], []],
    ...
    'app_evenement_rechercherevenement' => [[], ['_controller' => 'App\\Controller\\EvenementController::recherchErevenement'], [], [['text', '/rechercheevenement']], [], []],
    'delete_evenement' => [['id'], ['_controller' => 'App\\Controller\\EvenementController::deleteEvenement'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/evenement']], [], []],
    ...
    'structures' => [[], ['_controller' => 'App\\Controller\\StructureController::addStructure'], [], [['text', '/structure']], [], []],
    'structure' => [[], ['_controller' => 'App\\Controller\\StructureController::listStructure'], [], [['text', '/structure']], [], []],
    'app_structure_detailsstructure' => [['id'], ['_controller' => 'App\\Controller\\StructureController::detailsStructure'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/structure']], [], []],
    'delete_structure' => [['id'], ['_controller' => 'App\\Controller\\StructureController::deleteStructure'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/delete-structure']], [], []],
    'app_structure_modifistructure' => [['id'], ['_controller' => 'App\\Controller\\StructureController::modifiStructure'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/structure']], [], []],
    ...
    'app_user_adduser' => [[], ['_controller' => 'App\\Controller\\UserController::addUser'], [], [['text', '/addUser']], [], []],
    'app_user_detailsuser' => [['id'], ['_controller' => 'App\\Controller\\UserController::detailsUser'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/user']], [], []],
    'app_user_listusers' => [[], ['_controller' => 'App\\Controller\\UserController::listUsers'], [], [['text', '/user']], [], []],
