 ...
 */
class Direction extends \App\Entity\Direction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Direction' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Direction' . "\0" . 'libelle', '' . "\0" . 'App\\Entity\\Direction' . "\0" . 'societe'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Direction $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setLibelle(string $libelle): \App\Entity\Direction
    {
     ...
     * {@inheritDoc}
     */
    public function setSociete(?\App\Entity\Societe $societe): \App\Entity\Direction
    {
